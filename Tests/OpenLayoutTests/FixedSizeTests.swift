...
final class FixedSizeTests: XCTestCase {
    ...
    func testFixedSizeHorizontalOnly() {
        Utils.assertLeafLayout(
            Rectangle(1).fixedSize(horizontal: true, vertical: false),
    ...
    func testFixedSizeVerticalOnly() {
        Utils.assertLeafLayout(
            Rectangle(1).fixedSize(horizontal: false, vertical: true),
    ...
    func testFixedSizeNone() {
        Utils.assertLeafLayout(
            Rectangle(1).fixedSize(horizontal: false, vertical: false),
    ...
    func testFixedSizeWithPadding() {
        Utils.assertLeafLayout(
            Rectangle(1).fixedSize().padding(10),
            expectedLayout: "1: 45.0 45.0 10.0 10.0"
        )
    }
    ...
    func testPaddingWithFixedSize() {
        Utils.assertLeafLayout(
            Rectangle(1).padding(10).fixedSize(),
            expectedLayout: "1: 45.0 45.0 10.0 10.0"
        )
    }
    ...
    func testFixedSizeWithFrame() {
        Utils.assertLeafLayout(
            Rectangle(1).fixedSize().frame(minWidth: 20, minHeight: 30),
            expectedLayout: "1: 45.0 45.0 10.0 10.0"
        )
    }
    ...
    func testNestedFixedSize() {
        Utils.assertLeafLayout(
            Rectangle(1).fixedSize().fixedSize(horizontal: false, vertical: true),
            expectedLayout: "1: 45.0 45.0 10.0 10.0"
        )
    }
}
